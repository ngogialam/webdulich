...
<div class="container mt-2">
    <div class="text-center" style="margin-top: 30px;">
        <h2 class="text-primary">Miền Nam Biển Xanh Và Sông Nước</h2>
    </div>
    <div class="row">
        <?php
        $getToure = 'SELECT * FROM `toure` where mien = 3';
        $toure = conn()->query($getToure);
        while ($row = $toure->fetch_assoc()) {
            ?>
            <div class="col-6 mt-5 row">
            <a href=""><div class="col-6 tour" style="background-image: url('assets/image/toure/<?php echo $row["image"]?>'); width: 390px; height: 300px; max-width: 100%; border: solid 2px  #0d44f4;">
            </div></a>
            <div style="height: 320px; width: 400px; -webkit-box-flex: 0">
                <div class="" style="height: 320px">
                    <a href=""><h3 style="margin: 15px 0 15px 70px; color: blue;"><?php echo $row['name'];?></h3></a>
