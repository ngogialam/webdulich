...
<div class="container mt-2">
    ...
    <div class="row">
        ...
        if(isset($_GET['search'])){
            $getToure = "SELECT * FROM `toure` where name like '%".$_GET['search']."%'";
        }else{
            $getToure = 'SELECT * FROM `toure` ';
        }
        ...
        <div class="col-6 mt-5 row">
            ...
            <div style="height: 320px; width: 400px; -webkit-box-flex: 0">
                <div class="" style="height: 320px">
                    <a href="chitiettour?id=<?php echo $row['id'];?>"><h3 style="margin: 15px 40px 15px 50px; color: blue;"><?php echo $row['name'];?></h3></a>
